...
namespace Foobar.Dialog.Core.Builder
{
    public abstract class BaseUserInterfaceBuilder
    {
        ...
        protected virtual void FillProperty(object target, string targetPropertyName, object value)
        {
        ...
        protected virtual void FillCustomProperty(object target, string targetPropertyName, string keyAndConfiguration)
        {
            string key;
