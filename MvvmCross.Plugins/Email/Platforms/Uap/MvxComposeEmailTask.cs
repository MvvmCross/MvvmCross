...
namespace MvvmCross.Plugin.Email.Platforms.Uap
{
      ...
      : IMvxComposeEmailTaskEx
    {
        ...
        public async ValueTask ComposeEmail(IEnumerable<string> to, IEnumerable<string> cc = null, string subject = null, string body = null, bool isHtml = false, IEnumerable<EmailAttachment> attachments = null, string dialogTitle = null)
        {
