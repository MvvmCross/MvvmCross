...
Since we are not exclusively targeting .NET6.0, we needed to remove Windows Universal App support and Xamarin.Forms support, as these don't have .NET6.0 compatibility.
