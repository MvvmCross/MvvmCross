...
## Sample please!
You can browse the code of the [Playground](https://github.com/MvvmCross/MvvmCross/tree/main/Projects/Playground) (macOS project) to see this presenter in action.
