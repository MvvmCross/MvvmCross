...
{
    public class MvxCarouselPage : MvxEventSourceCarouselPage, IMvxPage
    {
        public MvxCarouselPage()
        {
    ...
    public class MvxCarouselPage<TViewModel> : MvxCarouselPage, IMvxPage<TViewModel>
