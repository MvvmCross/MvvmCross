...
namespace MvvmCross.Droid.Support.V7.RecyclerView.ItemSources
{
    internal class MvxRecyclerViewItemsSourceBridgeHeaderFooterDecorator : IMvxRecyclerViewItemsSourceBridge
    {
        ...
        public MvxRecyclerViewItemsSourceBridgeHeaderFooterDecorator(
        ...
        private bool ShouldShowHeader => IsHeaderEnabled &&
                                         (!HidesHeaderIfEmpty || _decoratedItemsSourceBridge.ItemsCount > 0);

        private bool ShouldShowFooter => IsFooterEnabled &&
                                         (!HidesFooterIfEmpty || _decoratedItemsSourceBridge.ItemsCount > 0);
        ...
        public object GetItemAt(int position)
        {
            ...
            var orginalItemPosition = position;
