...
namespace MvvmCross.Droid.Support.V4
{
    public static class MvxFragmentExtensions
    {
        ...
        public static void EnsureSetupInitialized(this IMvxFragmentView fragmentView)
        {
            ...
            var setupSingleton = MvxSetupSingleton.EnsureSingletonAvailable<MvxAndroidSetupSingleton>();
            setupSingleton.EnsureInitialized(fragment.Activity.ApplicationContext);
        }
