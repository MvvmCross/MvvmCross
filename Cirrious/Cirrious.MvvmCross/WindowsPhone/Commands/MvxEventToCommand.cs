...
namespace Cirrious.MvvmCross.WindowsPhone.Commands
{
    public class MvxEventToCommand : TriggerAction<DependencyObject>
    {
        ...
        public IMvxCommand Command
        {
            get
            {
                return (IMvxCommand)GetValue(CommandProperty);
            }
        ...
        private IMvxCommand GetCommand()
        {
            return Command;
        }
            ...
            DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue != null)
            {
                ((IMvxCommand)e.OldValue).CanExecuteChanged -= element.OnCommandCanExecuteChanged;
            }

            var command = (IMvxCommand)e.NewValue;
