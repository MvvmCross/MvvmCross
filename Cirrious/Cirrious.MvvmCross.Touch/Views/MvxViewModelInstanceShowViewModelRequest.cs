// MvxViewModelInstanceShowViewModelRequest.cs
...
{
    public class MvxViewModelInstanceShowViewModelRequest : MvxShowViewModelRequest
    {
        private readonly IMvxViewModel _viewModelInstance;

        public IMvxViewModel ViewModelInstance { get { return _viewModelInstance; } }

        public MvxViewModelInstanceShowViewModelRequest(IMvxViewModel viewModelInstance)
