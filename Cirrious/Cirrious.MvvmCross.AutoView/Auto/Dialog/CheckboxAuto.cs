...
// <copyright file="CheckboxAuto.cs" company="Cirrious">
...
namespace Cirrious.MvvmCross.AutoView.Auto.Dialog
{
    ...
    {
        public CheckboxAuto(string key = null, Expression<Func<object>> bindingExpression = null,
            ...
            : base(
                key ?? "Checkbox", bindingExpression, converter, converterParameter, value, caption, onlyFor, notFor,
