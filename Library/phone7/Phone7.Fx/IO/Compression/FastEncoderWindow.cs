...
namespace Phone7.Fx.IO.Compression
{
    internal class FastEncoderWindow
    {
        ...
        // Hashtable structure
        private readonly ushort[] _lookup; // hash table to find most recent occurance of chars with same hash value
        private readonly ushort[] _prev; // next most recent occurance of chars with same hash value
        private readonly byte[] _window; // complete bytes window
        ...
        public void MoveWindows()
        {
            ...
            {
                int val = (_lookup[i]) - FastEncoderWindowSize;
