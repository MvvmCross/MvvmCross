...
namespace MonoTouch.Dialog
{
	public class SegmentControl : UIControl
	{
		...
		public SegmentControl (UIColor[] colors)
			: base(new RectangleF(0, 0, BUTTON_WIDTH * colors.Length, BUTTON_WIDTH))
		{
			_segmentCount = colors.Length;

			for (int i = 0; i < colors.Length; i++)
			{
				ColorView view = new ColorView(new RectangleF(BUTTON_WIDTH * i, 0, BUTTON_WIDTH, BUTTON_WIDTH))
		...
		public SegmentControl (UIImage[] unselectedImages, UIImage[] selectedImages)
			: base(new RectangleF(0, 0, BUTTON_WIDTH * unselectedImages.Length, BUTTON_WIDTH))
		{
		...
		private class ColorView : UIControl
		{
			...
			public ColorView(RectangleF frame) : base(frame)
			{
