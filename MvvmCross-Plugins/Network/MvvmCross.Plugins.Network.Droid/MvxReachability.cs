...
namespace MvvmCross.Plugins.Network.Droid
{
    ...
    public class MvxReachability : IMvxReachability
    {
        ...
        protected ConnectivityManager ConnectivityManager
        {
            get
            {
                _connectivityManager = _connectivityManager ?? (ConnectivityManager) Mvx.Resolve<IMvxAndroidGlobals>()
        ...
        protected bool IsConnected
        {
            get
            {
                ...
                {
                    Mvx.Warning(
                        "Unable to get connected state - do you have ACCESS_NETWORK_STATE permission - error: {0}",
                        e.ToLongString());
                    return false;
                }
            }
