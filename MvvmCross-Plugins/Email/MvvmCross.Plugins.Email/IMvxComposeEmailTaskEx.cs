...
namespace MvvmCross.Plugins.Email
{
        ...
        : IMvxComposeEmailTask
    {
        ...
        /// </summary>
        /// <param name="to">
        ///     <see cref="IEnumerable{T}" /> of <see cref="string" /> containing the e-mail addresses
        ///     you want to send the e-mail to
        /// </param>
        /// <param name="cc">
        ///     <see cref="IEnumerable{T}" /> of <see cref="string" /> containing the e-mail addresses
        ///     you want to send a carbon copy to
        /// </param>
        ...
        ///     <see cref="IEnumerable{T}" /> of <see cref="EmailAttachment" /> containing
        ///     attachments
        /// </param>
