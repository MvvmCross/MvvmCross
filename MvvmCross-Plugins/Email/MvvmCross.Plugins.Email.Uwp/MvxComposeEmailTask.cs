...
namespace MvvmCross.Plugins.Email.WindowsCommon
{
        ...
        : IMvxComposeEmailTaskEx
    {
        ...
        public async void ComposeEmail(IEnumerable<string> to, IEnumerable<string> cc = null, string subject = null,
            ...
            if (attachments != null)
                foreach (var item in attachments)
                    email.Attachments.Add(
                        new Windows.ApplicationModel.Email.EmailAttachment(item.FileName, await GetTextFile(item))
                    );
