...
namespace MvvmCross.Plugins.Messenger
{
    public interface IMvxMessenger
    {
        ...
        /// <param name="tag">An optional tag to include with this subscription</param>
        /// <returns>MessageSubscription used to unsubscribing</returns>
        MvxSubscriptionToken SubscribeOnMainThread<TMessage>(Action<TMessage> deliveryAction,
            MvxReference reference = MvxReference.Weak, string tag = null)
            where TMessage : MvxMessage;
        ...
        /// <param name="tag">An optional tag to include with this subscription</param>
        /// <returns>MessageSubscription used to unsubscribing</returns>
        MvxSubscriptionToken SubscribeOnThreadPoolThread<TMessage>(Action<TMessage> deliveryAction,
            MvxReference reference = MvxReference.Weak, string tag = null)
            where TMessage : MvxMessage;
        ...
        ///     The type of the message to use for delivery - message should be of that class or a of a
        ///     subclass
        /// </param>
