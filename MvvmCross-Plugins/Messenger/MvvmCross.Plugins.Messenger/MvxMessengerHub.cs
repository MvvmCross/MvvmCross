...
namespace MvvmCross.Plugins.Messenger
{
    ...
    public class MvxMessengerHub : IMvxMessenger
    {
        ...
        public MvxSubscriptionToken Subscribe<TMessage>(Action<TMessage> deliveryAction,
        ...
        public MvxSubscriptionToken SubscribeOnThreadPoolThread<TMessage>(Action<TMessage> deliveryAction,
            MvxReference reference = MvxReference.Weak, string tag = null)
            where TMessage : MvxMessage
        {
        ...
        private MvxSubscriptionToken SubscribeInternal<TMessage>(Action<TMessage> deliveryAction,
            IMvxActionRunner actionRunner, MvxReference reference, string tag)
            where TMessage : MvxMessage
        {
