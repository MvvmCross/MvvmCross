...
namespace MvvmCross.iOS.Support.Views
{
    public static class ViewExtensions
    {
        ...
        public static UIView FindFirstResponder(this UIView view)
        {
            ...
            return view.Subviews.Select(subView => subView.FindFirstResponder())
        ...
        public static UIMotionEffect SetParallaxIntensity(this UIView view, float parallaxDepth,
            float? verticalDepth = null)
        {
            if (UIDevice.CurrentDevice.CheckSystemVersion(7, 0))
            {
                var vertical = verticalDepth ?? parallaxDepth;
                var verticalMotionEffect =
                ...
                var horizontalMotionEffect =
                    new UIInterpolatingMotionEffect("center.x",
            ...
            bool animated = false)
        {
            ...
            var adjustedFrame =
                UIApplication.SharedApplication.KeyWindow.ConvertRectFromView(scrollFrame, scrollView.Superview);
        ...
        public static void CenterView(this UIScrollView scrollView, UIView viewToCenter,
            nfloat keyboardHeight = default(nfloat), bool adjustContentInsets = true, bool animated = false)
        {
        ...
        public static bool IsLandscape()
        {
            ...
            var landscape = orientation == UIInterfaceOrientation.LandscapeLeft ||
