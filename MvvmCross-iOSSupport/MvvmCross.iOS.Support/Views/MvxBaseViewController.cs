...
namespace MvvmCross.iOS.Support.Views
{
    ...
    public abstract class MvxBaseViewController<TViewModel> : MvxViewController where TViewModel : IMvxViewModel
    {
        ...
        /// <summary>
        ///     Initialises the keyboard handling.  The view must also contain a UIScrollView for this to work.  You must also
        ///     override HandlesKeyboardNotifications() and return true from that method.
        /// </summary>
        ...
        protected void DismissKeyboardOnBackgroundTap()
        {
            ...
            tap.ShouldReceiveTouch =
                (recognizer, touch) => !(touch.View is UIControl ||
                                         touch.View.FindSuperviewOfType(View, typeof(UITableViewCell)) != null);
