...
{
	[TestFixture]
	public class ApplyMustBeCalledWhenUsingFluentBindingSetAnalyzerTests : DiagnosticVerifier<ApplyMustBeCalledWhenUsingFluentBindingSetAnalyzer> //CodeFixVerifier<ApplyMustBeCalledWhenUsingFluentBindingSetAnalyzer, ApplyMustBeCalledWhenUsingFluentBindingSetCodeFix>
	{
		...
		public void ApplyMustBeCalledWhenUsingFluentBindingSetShoudShowOneDiagnosticIfApplyIsNotCalled()
		{
			var expectedDiagnostic = new DiagnosticResult
			{
				...
				Locations =
					new[]
					{
						new DiagnosticResultLocation("Test0.cs", 24, 19)
					}
			};
