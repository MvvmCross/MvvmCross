...
namespace MvvmCross.CodeAnalysis.Test
{
    ...
    public abstract partial class CodeFixVerifier
    {
        ...
        /// </param>
        protected void VerifyCSharpFix(string oldSource, MvxProjType projType, string newSource,
            int? codeFixIndex = null, bool allowNewCompilerDiagnostics = false)
        {
            VerifyFix(GetCSharpDiagnosticAnalyzer(), GetCSharpCodeFixProvider(), null,
                new MvxTestFileSource(oldSource, projType), newSource, codeFixIndex, allowNewCompilerDiagnostics);
        }
        ...
        ///     introduces other warnings after being applied
        /// </param>
        protected void VerifyCSharpFix(MvxTestFileSource oldSource, string newSource, int? codeFixIndex = null,
            bool allowNewCompilerDiagnostics = false)
        {
            VerifyFix(GetCSharpDiagnosticAnalyzer(), GetCSharpCodeFixProvider(), null, oldSource, newSource,
        ...
        ///     introduces other warnings after being applied
        /// </param>
        protected void VerifyCSharpFix(MvxTestFileSource[] fileSources, string oldSource, MvxProjType projType,
            string newSource, int? codeFixIndex = null, bool allowNewCompilerDiagnostics = false)
        {
            VerifyFix(GetCSharpDiagnosticAnalyzer(), GetCSharpCodeFixProvider(), fileSources,
                new MvxTestFileSource(oldSource, projType), newSource, codeFixIndex, allowNewCompilerDiagnostics);
        }
        ...
        ///     introduces other warnings after being applied
        /// </param>
        protected void VerifyCSharpFix(MvxTestFileSource[] fileSources, MvxTestFileSource oldSource, string newSource,
            int? codeFixIndex = null, bool allowNewCompilerDiagnostics = false)
        {
            VerifyFix(GetCSharpDiagnosticAnalyzer(), GetCSharpCodeFixProvider(), fileSources, oldSource, newSource,
                codeFixIndex, allowNewCompilerDiagnostics);
        }
        ...
        ///     introduces other warnings after being applied
        /// </param>
        private static void VerifyFix(DiagnosticAnalyzer analyzer, CodeFixProvider codeFixProvider,
            MvxTestFileSource[] fileSources, MvxTestFileSource oldSource, string newSource, int? codeFixIndex,
