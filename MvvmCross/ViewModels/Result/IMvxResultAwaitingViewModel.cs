...
///     this.ReloadAndRegisterToResult&lt;<typeparamref name="TResult"/>&gt;(state, MvxHost.Current!.Services.GetRequiredService&lt;IMvxResultViewModelManager&gt;());
/// }
/// protected override void SaveStateToBundle(IMvxBundle bundle)
/// {
///     base.SaveStateToBundle(bundle);
///     this.SaveRegisterToResult&lt;<typeparamref name="TResult"/>&gt;(bundle, MvxHost.Current!.Services.GetRequiredService&lt;IMvxResultViewModelManager&gt;());
/// }
/// public override ViewDestroy(bool viewFinishing = true)
/// {
///     base.ViewDestroy();
///     if (viewFinishing)
///         this.UnregisterToResult&lt;<typeparamref name="TResult"/>&gt;(MvxHost.Current!.Services.GetRequiredService&lt;IMvxResultViewModelManager&gt;());
/// }
/// </code>
/// </summary>
