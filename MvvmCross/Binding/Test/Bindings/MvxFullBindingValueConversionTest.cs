...
namespace MvvmCross.Binding.Test.Bindings
{
    ...
    public class MvxFullBindingValueConversionTest : MvxIoCSupportingTest
    {
        ...
        {
            return TestSetupCommon(valueConverter, converterParameter, new {Value = 4}, targetType, out mockSource,
                out mockTarget);
        }
        ...
        public void TestConverterIsUsedForConvert()
        {
            ...
            var binding = TestSetupCommon(mockValueConverter, parameter, typeof(object), out mockSource,
                out mockTarget);
        ...
        public void TestDefaultValueIsUsedIfConversionFails_Int()
        {
            ...
            var binding = TestSetupCommon(mockValueConverter, parameter, fallback, typeof(int), out mockSource,
                out mockTarget);
        ...
        public void TestDefaultValueIsUsedIfConversionFails_Object()
        {
            ...
            var parameter = new {Ignored = 12};
            object fallback = null;
            var binding = TestSetupCommon(mockValueConverter, parameter, fallback, typeof(object), out mockSource,
                out mockTarget);
