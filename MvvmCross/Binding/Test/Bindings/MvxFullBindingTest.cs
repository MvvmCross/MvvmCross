...
namespace MvvmCross.Binding.Test.Bindings
{
    ...
    public class MvxFullBindingTest : MvxIoCSupportingTest
    {
        ...
        public class MockTargetBinding : IMvxTargetBinding
        {
            ...
            public int SubscribeToEventsCalled;
        ...
        private static void TwoWayAssertions(MvxFullBinding binding, MockTargetBinding mockTarget,
        ...
        private static void OneWayAssertions(MvxFullBinding binding, MockTargetBinding mockTarget,
            MockSourceBinding mockSource)
        {
        ...
        private static void OnWayToSourceAssertions(MvxFullBinding binding, MockTargetBinding mockTarget,
            MockSourceBinding mockSource)
        {
            Assert.AreEqual(1, mockTarget.SubscribeToEventsCalled);
        ...
        private static void OneTimeAssertions(MvxFullBinding binding, MockTargetBinding mockTarget,
            MockSourceBinding mockSource)
        {
            Assert.AreEqual(0, mockTarget.SubscribeToEventsCalled);
        ...
        public void TestDefaultOneTimeEventSubscription()
        {
            ...
            var binding = TestSetupCommon(MvxBindingMode.Default, MvxBindingMode.OneTime, out mockSource,
                out mockTarget);
        ...
        public void TestDefaultOneWayEventSubscription()
        {
            MockSourceBinding mockSource;
            MockTargetBinding mockTarget;
            var binding = TestSetupCommon(MvxBindingMode.Default, MvxBindingMode.OneWay, out mockSource,
                out mockTarget);
        ...
        public void TestDefaultOneWayToSourceEventSubscription()
        {
            MockSourceBinding mockSource;
            MockTargetBinding mockTarget;
            var binding = TestSetupCommon(MvxBindingMode.Default, MvxBindingMode.OneWayToSource, out mockSource,
                out mockTarget);
        ...
        public void TestDefaultTwoWayEventSubscription()
        {
            MockSourceBinding mockSource;
            MockTargetBinding mockTarget;
            var binding = TestSetupCommon(MvxBindingMode.Default, MvxBindingMode.TwoWay, out mockSource,
                out mockTarget);
