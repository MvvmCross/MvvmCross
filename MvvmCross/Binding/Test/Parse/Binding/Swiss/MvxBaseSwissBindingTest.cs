...
namespace MvvmCross.Binding.Test.Parse.Binding.Swiss
{
        ...
        where TParser : MvxSwissBindingParser, new()
    {
        ...
        public class PerformSimpleTestParams
        {
            ...
            {
                Source = sourcePath;
                UseInlinePath = useInlinePath;
                Target = targetName;
                BindingMode = bindingMode;
                TestBindingMode = testBindingMode;
                Converter = converter;
                ConverterParameterValue = converterParameterValue;
            ...
            public bool UseInlinePath { get; }

            public MvxBindingMode BindingMode { get; }

            public bool TestBindingMode { get; }

            public string Converter { get; }

            public KeyValuePair<string, object> ConverterParameterValue { get; }

            public KeyValuePair<string, object> FallbackValue { get; }
        }
    }
}