...
namespace MvvmCross.Binding.Droid.Views
{
    ...
    public class MvxLayoutInflater : LayoutInflater
    {
        ...
        public MvxLayoutInflater(LayoutInflater original, Context newContext, MvxBindingVisitor bindingVisitor,
            bool cloned)
        ...
        protected IMvxAndroidViewFactory AndroidViewFactory => _androidViewFactory ??
                                                               (_androidViewFactory =
        ...
        protected IMvxLayoutInflaterHolderFactoryFactory FactoryFactory => _layoutInflaterHolderFactoryFactory ??
                                                                           (_layoutInflaterHolderFactoryFactory = Mvx
                                                                               .Resolve<
        ...
        public override View Inflate(int resource, ViewGroup root, bool attachToRoot)
        {
            ...
            var originalFactory = _bindingVisitor.Factory;
        ...
        protected override View OnCreateView(string name, IAttributeSet attrs)
        {
            ...
            var view = AndroidViewFactory.CreateView(null, name, Context, attrs) ??
        ...
        private void SetupLayoutFactories(bool cloned)
        {
            ...
            if (Sdk > BuildVersionCodes.Honeycomb)
                if (Factory2 != null &&
                    !(Factory2 is MvxLayoutInflaterCompat.FactoryWrapper2)
            ...
            if (Factory != null &&
                !(Factory is MvxLayoutInflaterCompat.FactoryWrapper)) // Check for FactoryWrapper may be too loose
        ...
        private void SetPrivateFactoryInternal()
        {
            ...
            var layoutInflaterClass = Class.FromType(typeof(LayoutInflater));
            var setPrivateFactoryMethod =
                layoutInflaterClass.GetMethod("setPrivateFactory", Class.FromType(typeof(IFactory2)));
