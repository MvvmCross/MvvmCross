...
{
	public abstract class MvxAsyncAndroidSetup
		: MvxAsyncSetup, IMvxAndroidGlobals
	{
		protected MvxAsyncAndroidSetup(Context applicationContext)
		{
