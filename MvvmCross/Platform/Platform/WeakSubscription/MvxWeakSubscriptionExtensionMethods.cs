...
namespace MvvmCross.Platform.WeakSubscription
{
    public static class MvxWeakSubscriptionExtensionMethods
    {
        ...
        public static MvxWeakEventSubscription<TSource> WeakSubscribe<TSource>(this TSource source, string eventName,
        ...
        public static MvxWeakEventSubscription<TSource, TEventArgs> WeakSubscribe<TSource, TEventArgs>(
