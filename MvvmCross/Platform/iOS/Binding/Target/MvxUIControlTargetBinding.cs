...
namespace MvvmCross.Binding.iOS.Target
{
    public class MvxUIControlTargetBinding : MvxConvertingTargetBinding
    {
            ...
            : base(control)
        {
            ...
            if (control == null)
            {
                MvxBindingTrace.Error( "Error - UIControl is null in MvxUIControlTargetBinding");
            }
            else
            {
                AddHandler(control);    
        ...
        private void AddHandler(UIControl control)
        {
            switch (_controlEvent)
            {
                ...
                case MvxIosPropertyBinding.UIControl_AllEvents:
                    ...
                    break;
                default:
                    MvxBindingTrace.Error( "Error - Invalid controlEvent in MvxUIControlTargetBinding");
                    break;
            }
        }
