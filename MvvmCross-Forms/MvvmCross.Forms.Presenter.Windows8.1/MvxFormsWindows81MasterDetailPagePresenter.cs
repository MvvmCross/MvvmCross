...
{
    public class MvxFormsWindows81MasterDetailPagePresenter
        : MvxFormsMasterDetailPagePresenter
        , IMvxWindowsViewPresenter
    {
        private readonly IMvxWindowsFrame _rootFrame;

        public MvxFormsWindows81MasterDetailPagePresenter(IMvxWindowsFrame rootFrame, Application mvxFormsApp)
            : base(mvxFormsApp)
        {
