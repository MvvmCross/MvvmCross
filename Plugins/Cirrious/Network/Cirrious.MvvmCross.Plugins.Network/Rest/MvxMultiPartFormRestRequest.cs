...
namespace Cirrious.MvvmCross.Plugins.Network.Rest
{
        ...
        : MvxTextBasedRestRequest
    {
        ...
        public MvxMultiPartFormRestRequest(string url, string verb = MvxVerbs.Post, string accept = MvxContentType.Json, string tag = null) 
            : base(url, verb, accept, tag)
        {
            Initialise();
        }

        public MvxMultiPartFormRestRequest(Uri uri, string verb = MvxVerbs.Post, string accept = MvxContentType.Json, string tag = null) 
            ...
            : StreamForUpload
        {
            ...
            public MemoryStreamForUpload(string fieldName, string fileName, string contentType, MemoryStream memoryStream)
        ...
        public override bool NeedsRequestStream { get { return StreamsToSend != null && StreamsToSend.Count > 0; } }
